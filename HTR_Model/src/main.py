...
def postprocessing(fn_img: Path):
    ...
    headers = {
    "X-RapidAPI-Key": "d289f6cefbmshc7998234d100d8dp18f695jsn2ff434d179c5",
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--img_file', help='Image used for inference.', type=Path, default='3.jpeg')
...
def main():
    ...
    # infer text on test image
        ...
        k=Segment.segmentation("3.jpeg")
        for i in range(k):
            s=str(i)+".png"
            infer(model,str(s))
        postprocessing(str(args.img_file))
